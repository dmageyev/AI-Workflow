...
- [ ] Створено папку сесії: `logs/sessions/YYYY-MM-DD-topic/`
- [ ] Створено `snapshot.yaml` (усі обов'язкові поля заповнені)
- [ ] Створено `handoff.md` (усі секції заповнені)
- [ ] Оновлено `memory/state/project-state.yaml` (статуси work items, фаза, прогрес)
- [ ] Усі нові архітектурні рішення зафіксовані ADR у `memory/decisions/`
...
- [ ] Файл іменовано: `memory/decisions/NNNN-kebab-case-title.md`
