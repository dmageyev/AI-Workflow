...
- **Чеклист:** [`.ai/docs/04-quality-gates.md`](../../docs/04-quality-gates.md)

## Завдання для агента (Reviewer)

1. Відкрий артефакт.
2. Перевір за відповідним чеклістом із [`.ai/docs/04-quality-gates.md`](../../docs/04-quality-gates.md).
