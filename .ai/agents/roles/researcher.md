...
- Зберігає довготривалі знання у [`.ai/memory/knowledge/`](../../memory/knowledge/).
...
- **→ [`.ai/memory/knowledge/`](../../memory/knowledge/):** зберігає довготривалі знання для майбутніх сесій.
