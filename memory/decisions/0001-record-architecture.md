...
- `docs/` — документація архітектури та протоколів
- `prompts/` — системні та task-промпти для агентів
- `agents/` — реєстр та описи ролей
- `memory/` — довготривала пам'ять (glossary, knowledge, decisions, state)
...
- Orchestrator є єдиним власником `memory/state/project-state.yaml`.
